      ...
      <div className="mt-5 border-t border-slate-100 pt-4 sm:mt-6">
        {downloadLink ? (
          ...
          <button
            type="button"
            disabled
            className="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-xl bg-slate-100 px-4 py-2.5 text-sm font-semibold text-slate-500 sm:text-base"
            title="PDF link is not available yet"
          >
            PDF coming soon
          </button>
        )}
